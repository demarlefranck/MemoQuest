package com.memoquest.app.test;
        ...
        import com.memoquest.app.test.BirthProvider;

public class ActivityAppSyncTuto extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_sync_tuto);
    }
